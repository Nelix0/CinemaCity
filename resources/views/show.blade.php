            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="rounded-3 overflow-hidden bg-light h-100">
                        <img src="../public/{{$product->img }}" alt="{{ $product->title }}" class="w-100 h-100" style="min-height: 450px;">
                    </div>
                </div>
                ...
                <div class="col-md-6 d-flex flex-column justify-content-between">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="text-dark">{{ $product->type }}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="text-dark">{{ $product->width }}</div>
                        </div>

                        <div class="mb-2">
                            <span class="text-muted d-block small mb-1">Высота шкафа , мм</span>
                            <div class="text-dark">{{ $product->height }}</div>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-2">
                            <p class=" mb-4 " style="text-align: justify; font-size: 0.9rem; line-height: 1.4;">{{ $product->description }}</p>
                        </div>
                    ...
                    <div class="mt-auto pt-4 border-top">
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-sm-6">
                                <form action="{{ route('buy', $product->id) }}" method="get">
                                    @csrf
                                    <button type="submit" class="btn btn-dark w-100 py-2 fw-medium">
                                        Купить
                                    </button>
